...
LOGGER_ID = int(getenv("LOGGER_ID", -1002428897217))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/alphabotzchat")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Thealphabotz")
